"""Genera la representacion grafica de una Nota Debito como PDF -- mismo
patron que nota_credito_pdf.py."""
...
from src.infrastructure.db.models import Empresa, NotaDebito
...
def generar_representacion_pdf_nota_debito(db: Session, nota: NotaDebito, firma_digital: str | None) -> bytes:
    ...
    motivos = ReferenceTableService(db).listar("conceptos_nota_debito")
