...
export function validateFechaVencimiento(formaPago, fechaVencimiento, fecha) {
  if (formaPago !== FORMA_PAGO_CREDITO) return "";
  if (!fechaVencimiento) return "La fecha de vencimiento es obligatoria para crédito.";
  if (fecha && fechaVencimiento < fecha) return "La fecha de vencimiento no puede ser anterior a la fecha de la factura.";
  return "";
}
