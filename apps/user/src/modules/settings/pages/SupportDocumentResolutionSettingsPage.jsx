...
import { validateField } from "./SupportDocumentResolutionSettingsPage.validation";
...
export default function SupportDocumentResolutionSettingsPage() {
    ...
    <div className="min-h-screen flex bg-neutralCustom-50 font-sans">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="h-16 bg-white border-b border-neutralCustom-100 flex items-center justify-between px-8 shrink-0">
          <div>
            <h2 className="text-lg font-medium text-neutralCustom-800">Resolución Documento Soporte</h2>
            <p className="text-xs text-neutralCustom-500">
              Numeración autorizada para tus Documentos Soporte de Adquisiciones.
            </p>
          </div>
        </header>
