...
export default function DebitNoteDetailPage() {
  ...
  const handleVerRepresentacion = async () => {
    ...
    await abrirRepresentacion({
      ...
      obtenerPdf: () => obtenerRepresentacionPdfNotaDebito(id),
      navigate,
      rutaPreview: `/debit-notes/${id}/representacion`,
        ...
        <header className="h-16 bg-white border-b border-neutralCustom-100 flex items-center justify-between px-8 shrink-0">
          <div>
            <div className="flex items-center gap-2 text-xs text-neutralCustom-500 mb-0.5">
              <Button onClick={() => navigate("/debit-notes")} variant="link">
                Notas débito
              </Button>
              <span>/</span>
                ...
                <div className="flex flex-wrap gap-3">
                  {(nota.estado === "borrador" || nota.estado === "rechazada") && (
                    <>
                      ...
                      <ConfirmPopover
                        message="¿Eliminar este borrador de nota débito?"
