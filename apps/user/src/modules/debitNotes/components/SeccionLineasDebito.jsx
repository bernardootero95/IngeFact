...
export default function SeccionLineasDebito({ seleccion, error, onToggleLinea, onCantidadChange }) {
  return (
    <div className="bg-white border border-neutralCustom-100 rounded-brand-lg shadow-sm p-6">
      <h3 className="text-base font-semibold text-neutralCustom-800 mb-1">Líneas a cargar</h3>
      <p className="text-xs text-neutralCustom-500 mb-4">
        Selecciona las líneas y la cantidad a cargar — una nota débito agrega un cargo, no tiene tope.
      </p>
