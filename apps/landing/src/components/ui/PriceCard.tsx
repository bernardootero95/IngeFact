...
export function PriceCard({ documentos, precio, precioPorDocumento, destacado }: PricingPackage) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-5 mt-1 text-xs text-neutralCustom-500">{precioPorDocumento} por documento</div>
      <a
      ...
      >
        ...
        Comprar
        <span className="sr-only"> paquete de {documentos} documentos por {precio}</span>
        <NewTabHint />
      </a>
    </div>
  );
