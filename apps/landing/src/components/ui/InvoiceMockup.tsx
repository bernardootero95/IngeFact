...
/** Ilustración de una factura: datos ficticios, no es un documento real. */
export function InvoiceMockup() {
  return (
    <figure className="w-full max-w-[420px] flex-shrink-0">
      <div
        role="img"
        aria-label="Ejemplo de factura electrónica aceptada por la DIAN, con productos, IVA, total y código CUFE"
        className="rounded-brand-lg border border-neutralCustom-100 bg-white p-6 shadow-[0_20px_40px_-18px_rgba(26,28,35,0.18)]"
      >
      ...
      <figcaption className="mt-2 text-center text-xs text-neutralCustom-500">Ejemplo ilustrativo con datos ficticios.</figcaption>
    </figure>
  );
}
