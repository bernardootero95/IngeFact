...
export const GUIDE_GROUPS: GuideGroup[] = [
  {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          "Revisa cuántos documentos has emitido y cuántos clientes tienes registrados.",
          "Consulta tus documentos disponibles: cuántos has usado de tu paquete y cuántos te quedan.",
          "El indicador de conexión con la DIAN te confirma que tu empresa está lista para facturar.",
          "Desde el menú lateral accedes a Documentos, Terceros, Catálogo y Configuración.",
        ],
      },
    ],
  },
  {
    ...
    guides: [
      ...
      },
      {
        ...
        steps: [
          "Desde el detalle de una factura aceptada, usa el botón \"Nota crédito\".",
      ...
      },
      {
        ...
        steps: [
          "En el detalle de una factura aceptada, usa el botón \"Anular\".",
  ...
  {
    title: "Nómina, documento soporte y facturas recibidas",
    guides: [
      {
        slug: "nomina-electronica",
        icon: PayrollIcon,
        title: "Emitir un comprobante de nómina",
        description: "Registra al empleado y transmite su nómina electrónica a la DIAN.",
        intro:
          "La nómina electrónica no usa resolución de numeración: IngeFact lleva el consecutivo por ti. Primero registra al empleado en Terceros → Empleados.",
        steps: [
          "Ve a Terceros → Empleados → Nuevo empleado y completa tipo de trabajador, contrato, salario y lugar de trabajo.",
          "Ve a Documentos → Nómina → Nuevo comprobante y elige el empleado: sus datos se copian al comprobante.",
          "Indica el periodo, las fechas de liquidación y de pago, y la forma y el método de pago.",
          "Completa los devengados (básico, transporte, horas extra, vacaciones, prima, cesantías, incapacidades…) y las deducciones (salud, pensión, retención…).",
      ...
      },
      {
        ...
        icon: ReceiptIcon,
        title: "Emitir un documento soporte",
        description: "Para compras a proveedores que no están obligados a facturar.",
        intro:
          "El documento soporte tiene su propia resolución de numeración, distinta de la de facturación. Configúrala antes de emitir el primero.",
        steps: [
          "Ve a Configuración → Resoluciones DIAN y registra la resolución de documento soporte que te autorizó la DIAN.",
          "Registra al proveedor en Terceros → Proveedores con su NIT, tipo de organización y dirección.",
          "Ve a Documentos → Documento Soporte → Nuevo documento, elige el proveedor y agrega los productos o servicios comprados.",
          "Usa \"Guardar borrador\" o envíalo a la DIAN.",
          "Ya aceptado, descarga el PDF o el XML, o envíalo por correo al proveedor.",
        ],
        note: "Cada documento soporte aceptado descuenta un documento de tu paquete.",
      },
      {
        slug: "aceptar-facturas-recibidas",
        icon: InboxCheckIcon,
        title: "Aceptar o reclamar una factura recibida",
        description: "Registra los eventos RADIAN sobre las facturas que te emiten tus proveedores.",
        intro:
          "Cuando un proveedor te emite una factura electrónica, puedes informar a la DIAN que la recibiste, que recibiste lo facturado y si la aceptas o la reclamas.",
        steps: [
          "Ve a Documentos → Facturas Recibidas → Registrar e ingresa el CUFE de la factura y el proveedor.",
          "Abre la factura registrada y, en \"Registrar nuevo evento\", elige el tipo de evento.",
          "Normalmente el orden es: acuse de recibo, recibo del bien o servicio y, al final, aceptación expresa o reclamo.",
    ...
    guides: [
      {
        ...
        steps: [
          "Ve a Configuración → Resoluciones DIAN.",
          ...
          "Si tu resolución ya está registrada ante la DIAN, puedes usar \"Importar\" para prellenar el formulario.",
          "Guarda los cambios.",
        ],
      },
      {
      ...
      },
      {
        ...
        steps: [
          ...
          "Con la nueva resolución en mano, vuelve a Configuración → Resoluciones DIAN.",
    ...
    guides: [
      {
        ...
        steps: [
          "Ve a Terceros → Clientes → Nuevo cliente.",
